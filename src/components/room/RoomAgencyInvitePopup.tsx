/**
 * مودال دعوة عضوية الوكالة — يظهر للمدعو داخل الروم
 */
...
import type { AgencyInvite } from '@/services/agencyService';
...
export function RoomAgencyInvitePopup({ invite, loading, onAccept, onDecline }: Props) {
