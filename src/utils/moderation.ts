...
const DEFAULT_BANNED_TERMS: string[] = [
  ...
  'starmaker',
  'toptop',
  // تطبيقات دردشة صوتية منافسة إضافية (بلاغات المختبرين — إعلانات تطبيقات أخرى)
  'higo', 'هيجو', 'هايجو', 'هيغو', 'هيقو', 'هيكو',
  'poppo', 'بوبو',
  'uplive', 'ابلايف', 'أبلايف',
  'tango', 'تانجو', 'تانغو',
  'hakuna', 'هاكونا',
  'yoosee', 'yola', 'يولا',
  // تطبيقات مراسلة — تُستخدم لسحب المستخدمين خارج المنصة (بلاغات المختبرين)
  'telegram', 'تلغرام', 'تلجرام', 'تلقرام', 'تلكرام',
  'تليجرام', 'تليغرام', 'تيليجرام', 'تيليغرام', 'تيلجرام', 'تيلغرام',
  'whatsapp', 'واتساب', 'الواتساب', 'وتساب', 'واتس', 'الواتس', 'وتس',
  'snapchat', 'سنابشات', 'سناب', 'السناب', 'سنابي', 'سنابك',
  'instagram', 'انستا', 'الانستا', 'انستغرام', 'انستقرام', 'انستجرام',
  'انستاغرام', 'انستاقرام', 'انستاجرام',
  // عبارات مركّبة
  'yalla ludo', 'يلا لودو',
  ...
  'ستار ميكر',
  'lama chat', 'لاما شات',
  'higo chat', 'هيجو شات', 'up live', 'اب لايف',
  'ليت ماتش', 'لايت ماتش',
  'top top', 'توب توب',
  'سناب شات', 'واتس اب', 'واتس آب', 'انستا غرام',
];
