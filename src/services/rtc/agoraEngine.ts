 ...
 * لكامل شاشة الغرفة عدة مرات بالثانية طول ما أحد يتكلّم → تسخين وبطء. 700ms
 * (~1.4 مرة/ثانية) يخفض الحِمل أكثر مع إبقاء مؤشّر المتحدّث سلساً بما يكفي.
 */
const VOLUME_INDICATION_INTERVAL_MS = 700;
