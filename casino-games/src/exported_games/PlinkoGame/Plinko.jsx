...
function Plinko({
    ...
    useEffect(() => {
        ...
        engine.updateSoundEnabled(soundEnabled);
        engine.start();
    ...
    useEffect(() => {
        if (plinkoEngine) {
            plinkoEngine.updateSoundEnabled(soundEnabled);
        }
    }, [soundEnabled, plinkoEngine]);
    ...
    return (
        <div className={`plinko${isEmbed ? ' plinko-embed' : ''}`} ref={containerRef}>
            <div className="plinko-content">
                <div className="plinko-board-wrapper">
                    <div
                        className="plinko-canvas-container"
                        style={isEmbed ? undefined : { aspectRatio: `${WIDTH} / ${HEIGHT}` }}
                    >
                        {isLoading && (
