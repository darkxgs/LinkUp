function CGame(oData){
    ...
    this._rouletteAnimEnded = function(){
        ...
        if(_iNumberExtracted === 0){
                _oPlaceHolder.x = _oTableController.getEnlightX(_iNumberExtracted) +22;
                _oPlaceHolder.y = _oTableController.getEnlightY(_iNumberExtracted) + 90;
        }else{
        ...
        this._lastWinAmount = iWin;
        this._lastStakeAmount = _oMySeat.getCurBet();
        $(s_oMain).trigger("save_score",_oMySeat.getCredit());
        $(s_oMain).trigger("round_result",{win:iWin,stake:_oMySeat.getCurBet(),credit:_oMySeat.getCredit()});
    ...
    this.getCurBet = function(){ return _oMySeat.getCurBet(); };
    this.getCredit = function(){ return _oMySeat.getCredit(); };
    this.getLastWin = function(){ return this._lastWinAmount || 0; };
