function CFicheBut(iIndex,iXPos,iYPos,oSprite){
    ...
    this._init =function(iXPos,iYPos,oSprite){
        ...
        oWhiteCircle.graphics.beginFill("#ffffff").drawCircle(0, 0, 16);
        _oContainer.addChild(oWhiteCircle);

        _oTextValue = new CTLText(_oContainer, 
                    -15, -15, 30, 30, 
                    22, "center","#000" , FONT1, 1,
                    0, 0,
                    szValueText,
                    true, true, false,
                    false );
	...
	var matrix = new createjs.ColorMatrix().adjustSaturation(-90);
        ...
        _oButton.cache(-_iWidth/2,-_iHeight/2,_iWidth,_iHeight);
        
        _oTextValue.setColor("#b5b5b5");
    };
