function CNeighborsPanel(){
    ...
    this.clearLastBet = function(){
        ...
        _aValueFichesInPos[iNumberSelected] = roundDecimal(_aValueFichesInPos[iNumberSelected],2);
    ...
    this.addFicheOnNeighborTable = function(){
        ...
        if( (_iCurBet + (iFicheValue*5) ) >_iTotMoney){
            ...
            _iCurBet = roundDecimal(_iCurBet,2);
            var iAmount = (_iTotMoney - _iCurBet);
            iAmount = roundDecimal(iAmount,2);
        ...
        _aValueFichesInPos[_iNumberClicked] = roundDecimal(_aValueFichesInPos[_iNumberClicked],2);
