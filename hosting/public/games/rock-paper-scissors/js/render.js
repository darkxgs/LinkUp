...
function formatBalance(amount) {
    if (window.CasinoCoins && CasinoCoins.isEmbedded()) {
        return CasinoCoins.formatAmount(amount, 16);
    }
    return `$${amount}`;
}

function applyCoinUI() {
    if (window.CasinoCoins && CasinoCoins.isEmbedded()) {
...
function renderWagerScreen() {
    document.getElementById('p1-balance').innerHTML = formatBalance(wallet.getBalance('p1'));
    document.getElementById('p2-balance').innerHTML = formatBalance(wallet.getBalance('p2'));
    applyCoinUI();
...
function renderPickScreen() {
    document.getElementById('current-player-balance').innerHTML = formatBalance(wallet.getBalance('p1'));
    ...
    document.getElementById('p2-pick-balance').innerHTML = formatBalance(wallet.getBalance('p2'));
